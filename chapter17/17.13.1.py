...
# You should not have to modify the test code in main. When you are done, the output should be
# the same as before. Solution: http://thinkpython2.com/code/Time2_soln.py.
...
class Time:
    ...
    def __init__(self, hour=0, minute=0, second=0):
        ...
        # Convert given time into seconds since midnight
        self.seconds_since_midnight = (hour * 3600) + (minute * 60) + second

    def __str__(self):
        """Returns a string representation of the time."""

        hour, minute= divmod(self.seconds_since_midnight, 3600)
...
def int_to_time(seconds):
    ...
    """
    time = Time()
    time.seconds_since_midnight = seconds
    return time
